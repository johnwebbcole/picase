...
You can search [NPM](https://www.npmjs.com/search?q=jscad) for other jscad libraries. Installing them with NPM and running `gulp` should create a `dist/picase.jscad` will all dependencies injected into the file.
...
If you publish the `dist/picase.jscad` file, you can open it directly in
